...
public interface WithdrawStrategy {
	 ...
	 *            not be null, but may be and empty list. This list is not
	 *            modified.
	 * @return if a solution is found, return a List contain referencs from
	 *         money parameter (List) whose sum equals the amount. If a solution
